...
class GameResources {
  ...
  var playerChoices = List(sp.houses.sower.Sower, sp.houses.mecanic.Mecanic)
//  var playerChoices = List(sp.houses.lostChurch.LostChurch, sp.houses.mecanic.Mecanic)
